...
void pwm_Config(PWM_Handler_t *ptrPwmHandler){
	...
	case PWM_CHANNEL_1:
	{
		...
		/* agregue acá su código */
		// ptrPwmHandler->ptrTIMx->CCER &= ~TIM_CCER_CC1E;  Desactivamos la entrada ?
	...
	case PWM_CHANNEL_2:
	{
		// Seleccionamos como salida el canal
		/* agregue acá su código */
		// ptrPwmHandler->ptrTIMx->CCER &= ~TIM_CCER_CC2E;  Desactivamos la entrada ?
		ptrPwmHandler->ptrTIMx->CCMR2 |= TIM_CCMR1_CC2S;

		// Configuramos el canal como PWM
		/* agregue acá su código */
		ptrPwmHandler->ptrTIMx->CCMR2 |= TIM_CCMR2_OC3M_1 | TIM_CCMR1_OC2M_2;
	...
	case PWM_CHANNEL_3:
	{
		// Seleccionamos como salida el canal
		/* agregue acá su código */
		// ptrPwmHandler->ptrTIMx->CCER &= ~TIM_CCER_CC3E;  Desactivamos la entrada ?
	...
	case PWM_CHANNEL_4:
	{
		// Seleccionamos como salida el canal
		/* agregue acá su código */
		// ptrPwmHandler->ptrTIMx->CCER &= ~TIM_CCER_CC4E;  Desactivamos la entrada ?
		ptrPwmHandler->ptrTIMx->CCMR2 |= TIM_CCMR2_CC4S;

		// Configuramos el canal como PWM
		/* agregue acá su código */
		ptrPwmHandler->ptrTIMx->CCMR2 |= TIM_CCMR2_OC4M_1 | TIM_CCMR1_OC1M_2;
