...
void config_SysTick_ms (uint8_t systemClock )
{
	...
	// Cargando el valor del limite de inrcementos que represneta 1ms
	switch(systemClock)
	{
	...
	// Matriculamos la interrupcione en el NVIC
...
void delay_ms (uint32_t wait_time_ms)
{
	...
	// Compara : si el valor "counting" es menor que "start + wait"
